...
outpath = path + sep + 'blob analysis normalized by old norm_mats'
    ...
    if current_frame not in ex1.missing_frames:
        try:
            tag_frame, fluo_frame, output_frame, available_frame_to_read, acquisition, th = \
                ex1.create_combined_frame(trim_coordinates, frame_sizes, transformation_matrix, bg_masks, norm_mats)
        except:
            break
